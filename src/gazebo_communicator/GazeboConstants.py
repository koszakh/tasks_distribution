...
WORKER_MODEL_PATH = WS_ROOT_PATH + '/catkin_ws/src/tasks_distribution/urdf/pioneer3at_aruco.urdf'
CHARGER_MODEL_PATH = WS_ROOT_PATH + '/catkin_ws/src/tasks_distribution/urdf/pioneer3at_cam.urdf'
...
MISSION_LOG_PATH = '/root/mission_time_log.txt'
